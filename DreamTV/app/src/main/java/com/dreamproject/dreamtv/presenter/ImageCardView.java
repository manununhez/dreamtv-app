package com.dreamproject.dreamtv.presenter;
...
import static com.dreamproject.dreamtv.R.styleable.lbImageCardView;
...
public class ImageCardView extends BaseCardView{
        ...
        /**
         * Create an ImageCardViewCustom using a given theme for customization.
         *
         * @param context
         *            The Context the view is running in, through which it can
         *            access the current theme, resources, etc.
         * @param themeResId
         *            The resourceId of the theme you want to apply to the ImageCardViewCustom. The theme
         *            includes attributes "imageCardViewStyle", "imageCardViewTitleStyle",
         *            "imageCardViewContentStyle" etc. to customize individual part of ImageCardViewCustom.
        ...
        private void buildImageCardViewCustom(AttributeSet attrs, int defStyleAttr, int defStyle) {
            // Make sure the ImageCardViewCustom is focusable.
            setFocusable(true);
            ...
            // Backward compatibility: Newly created ImageCardViewCustoms should change
