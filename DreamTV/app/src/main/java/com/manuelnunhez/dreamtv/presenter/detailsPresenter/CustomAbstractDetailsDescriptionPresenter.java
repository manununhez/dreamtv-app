...
public abstract class CustomAbstractDetailsDescriptionPresenter extends Presenter {
    ...
    public static class ViewHolder extends Presenter.ViewHolder {
        ...
        public ViewHolder(final View view) {
            ...
            int lb_details_description_body_max_lines = 5;
            mBodyMaxLines = lb_details_description_body_max_lines;
            int lb_details_description_body_min_lines = 3;
            mBodyMinLines = lb_details_description_body_min_lines;
            int lb_details_description_title_max_lines = 3;
            ...
            mTitle.addOnLayoutChangeListener((v, left, top, right, bottom, oldLeft, oldTop, oldRight, oldBottom) -> addPreDrawListener());
        }
