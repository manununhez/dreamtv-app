...
package com.dream.dreamtv.details;
...
import com.dream.dreamtv.adapter.DetailsDescriptionPresenterExample;
...
public class DetailViewExampleFragment extends DetailsFragment implements OnItemViewClickedListener,
    ...
    private void setupUi() {
        ...
        FullWidthDetailsOverviewRowPresenter rowPresenter = new FullWidthDetailsOverviewRowPresenter(
                new DetailsDescriptionPresenterExample()) {
...
//        detailsOverview.setImageDrawable(getResources().getDrawable(imageResId, null));
        detailsOverview.setImageDrawable(getResources().getDrawable(R.drawable.ted_logo, null));
    ...
    public void onItemClicked(Presenter.ViewHolder itemViewHolder, Object item,
        ...
        if (action.getId() == ACTION_RELATED) {
            ...
            Toast.makeText(getActivity(), getString(R.string.action_clicked), Toast.LENGTH_LONG)
                    .show();
        }
    }
