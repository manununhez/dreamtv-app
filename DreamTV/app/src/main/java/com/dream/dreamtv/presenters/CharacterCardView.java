    ...
    public CharacterCardView(Context context) {
        ...
        setOnFocusChangeListener(new OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if (hasFocus) {
                    container.setBackgroundResource(R.drawable.ic_pause_playcontrol_focussed);
                    mainImage.setBackgroundResource(R.drawable.ic_pause_playcontrol_focussed);
                } else {
                    container.setBackgroundResource(R.drawable.ic_play_action_focussed);
                    mainImage.setBackgroundResource(R.drawable.ic_play_action_normal);
                }
            }
        });
        setFocusable(true);
