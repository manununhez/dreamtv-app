...
public class ErrorSelectionDialogFragment extends DialogFragment {
    ...
    public static ErrorSelectionDialogFragment newInstance(SubtitleResponse subtitle, int subtitlePosition, int idTask, UserTask userTask) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        userTaskList = getArguments().getParcelable(USER_TASK);
    }
    ...
    private void setupSubtitleNavigation(final int subtPosition) {
        ...
        MySubtitleAdapter mySubtitleAdapter = new MySubtitleAdapter(getActivity(), subtitle.subtitles,
                subtPosition, user.interfaceMode);
    ...
    private void controlUserTask() {
        ...
        if (userTaskList != null && userTaskList.userTaskList.size() > 0) {
    ...
    private void repopulateFormWithUserTaskData() {
        ...
        //Interface mode settings
        User user = ((DreamTVApp) getActivity().getApplication()).getUser();
        if (user.interfaceMode.equals(Constants.BEGINNER_INTERFACE_MODE)) { //BEGINNER MODE
    ...
    public class MySubtitleAdapter extends ArrayAdapter<Subtitle> {
        ...
        MySubtitleAdapter(Context context, List<Subtitle> values, int currentSubtitlePosition, String userInterfaceMode) {
